...
class Register extends React.Component{
    ...
    isFormValid=()=>{  
        ...
        {
         error={message:"Fill in the details"}  
...
<Form.Input fluid name='passwordConfirmation' icon='repeat' iconPosition="left"
                              placeholder="Password Confirmation" onChange={this.handleChange} type='password' value={passwordConfirmation} className={this.handleInputError(errors,'password')} />
